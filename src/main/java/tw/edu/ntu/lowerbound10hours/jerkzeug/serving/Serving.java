...
public class Serving {
  public static BaseWSGIServer makeServer(InetAddress host, int port, Application app) throws Exception {
    BaseWSGIServer server = new BaseWSGIServer(host, port, app);
    return server;
  }

  public static void runSimple(InetAddress hostname, int port, Application application) throws Exception {
    //TODO
    //use_reloader=False,
    //use_debugger=False,
    //use_evalex=True,
